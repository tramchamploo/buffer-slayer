...
public final class SizeBoundedQueueBenchmark_mild_contention_jmhTest {
    ...
    public BenchmarkTaskResult mild_contention_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_sizeboundedqueuebenchmark0_G.mild_contention_drain(l_draincounters1_0, l_consumermarker2_1);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            mild_contention_drain_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_draincounters1_0, l_consumermarker2_1, l_sizeboundedqueuebenchmark0_G);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "mild_contention", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new ThroughputResult(ResultRole.SECONDARY, "mild_contention_drain", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            while (control.warmupShouldWait) {
                ...
                l_sizeboundedqueuebenchmark0_G.mild_contention_offer(l_offercounters3_2);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            mild_contention_offer_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_offercounters3_2, l_sizeboundedqueuebenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new ThroughputResult(ResultRole.PRIMARY, "mild_contention", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new ThroughputResult(ResultRole.SECONDARY, "mild_contention_offer", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
    ...
    public BenchmarkTaskResult mild_contention_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            mild_contention_drain_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_draincounters1_0, l_consumermarker2_1, l_sizeboundedqueuebenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps /= batchSize;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "mild_contention", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new AverageTimeResult(ResultRole.SECONDARY, "mild_contention_drain", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
        ...
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            notifyControl.startMeasurement = true;
            mild_contention_offer_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_offercounters3_2, l_sizeboundedqueuebenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "mild_contention", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new AverageTimeResult(ResultRole.SECONDARY, "mild_contention_offer", res.measuredOps, res.getTime(), benchmarkParams.getTimeUnit()));
    ...
    public static void mild_contention_drain_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SizeBoundedQueueBenchmark_DrainCounters_jmhType l_draincounters1_0, SizeBoundedQueueBenchmark_ConsumerMarker_jmhType l_consumermarker2_1, SizeBoundedQueueBenchmark_jmhType l_sizeboundedqueuebenchmark0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public static void mild_contention_offer_avgt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SizeBoundedQueueBenchmark_OfferCounters_jmhType l_offercounters3_2, SizeBoundedQueueBenchmark_jmhType l_sizeboundedqueuebenchmark0_G) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult mild_contention_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            mild_contention_drain_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_draincounters1_0, l_consumermarker2_1, l_sizeboundedqueuebenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            res.measuredOps *= opsPerInv;
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "mild_contention", buffer, benchmarkParams.getTimeUnit()));
            results.add(new SampleTimeResult(ResultRole.SECONDARY, "mild_contention_drain", buffer, benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            int opsPerInv = benchmarkParams.getOpsPerInvocation();
            SampleBuffer buffer = new SampleBuffer();
            mild_contention_offer_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_offercounters3_2, l_sizeboundedqueuebenchmark0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult(res.allOps, res.measuredOps);
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "mild_contention", buffer, benchmarkParams.getTimeUnit()));
            results.add(new SampleTimeResult(ResultRole.SECONDARY, "mild_contention_offer", buffer, benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public BenchmarkTaskResult mild_contention_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            mild_contention_drain_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_draincounters1_0, l_consumermarker2_1, l_sizeboundedqueuebenchmark0_G);
            control.preTearDown();
            if (SizeBoundedQueueBenchmark_jmhType.tearIterationMutexUpdater.compareAndSet(l_sizeboundedqueuebenchmark0_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "mild_contention", res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new SingleShotResult(ResultRole.SECONDARY, "mild_contention_drain", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
        if (threadParams.getSubgroupIndex() == 1) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            mild_contention_offer_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_offercounters3_2, l_sizeboundedqueuebenchmark0_G);
            control.preTearDown();
            if (SizeBoundedQueueBenchmark_jmhType.tearIterationMutexUpdater.compareAndSet(l_sizeboundedqueuebenchmark0_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
            ...
            BenchmarkTaskResult results = new BenchmarkTaskResult(totalOps, totalOps);
            results.add(new SingleShotResult(ResultRole.PRIMARY, "mild_contention", res.getTime(), benchmarkParams.getTimeUnit()));
            results.add(new SingleShotResult(ResultRole.SECONDARY, "mild_contention_offer", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    ...
    public static void mild_contention_offer_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SizeBoundedQueueBenchmark_OfferCounters_jmhType l_offercounters3_2, SizeBoundedQueueBenchmark_jmhType l_sizeboundedqueuebenchmark0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
