...
/**
 * Adapted from netty, used for scheduling queue's timeout
 *
 *
 ...
 *
 * {@link HashedWheelTimer} creates a new thread whenever it is instantiated and started.
 * Therefore, you should make sure to create only one instance and share it across your application.
 *  One of the common mistakes, that makes your application unresponsive, is to create a new
 ...
 * More comprehensive slides are located
...
public class HashedWheelTimer implements Timer {
  ...
  private final Queue<HashedWheelTimeout> timeouts = new MpscUnboundedArrayQueue<>(MPSC_CHUNK_SIZE);
  private final Queue<HashedWheelTimeout> cancelledTimeouts = new MpscUnboundedArrayQueue<>(MPSC_CHUNK_SIZE);
   ...
   * newTimeout} will result in {@link RejectedExecutionException} being thrown. No maximum pending
